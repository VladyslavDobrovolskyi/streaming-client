        ...
        {clients.map((clientID) => (
          <div
            ...
            style={{
              ...
              cursor: "move",
              display:
                (clientID === LOCAL_VIDEO && cameraMuted) || participantCameras[clientID] === true ? "none" : "block",
            }}
            draggable
              ...
              <video
                ...
                ref={(instance) => {
                  ...
                  if (videoElement && clientID !== LOCAL_VIDEO) {
                    videoElement.then(() => {
                      const video = document.querySelector(`video[data-client-id="${clientID}"]`) as HTMLVideoElement
                      if (video) {
  ...
  return (
    ...
    >
                  ...
                  >
                    <DropdownMenu.Item
                      ...
                      style={{
                        ...
                        alignItems: "center",
                        gap: "8px",
                        backgroundColor: hoveredItem === "mic" ? "rgba(255, 255, 255, 0.1)" : "transparent",
                        color: "white",
                        border: "none",
                        width: "100%",
                        textAlign: "left",
                    ...
                    <DropdownMenu.Item
                      ...
                      style={{
                        ...
                        alignItems: "center",
                        gap: "8px",
                        backgroundColor: hoveredItem === "camera" ? "rgba(255, 255, 255, 0.1)" : "transparent",
                        color: "white",
                        border: "none",
                        width: "100%",
                        textAlign: "left",
                    ...
                    <DropdownMenu.Item
                      ...
                      style={{
                        ...
                        alignItems: "center",
                        gap: "8px",
                        backgroundColor: hoveredItem === "movieMode" ? "rgba(255, 255, 255, 0.1)" : "transparent",
                        color: "white",
                        border: "none",
                        width: "100%",
                        textAlign: "left",
                    ...
                    <DropdownMenu.Item
                      ...
                      style={{
                        ...
                        alignItems: "center",
                        gap: "8px",
                        backgroundColor: hoveredItem === "hideUsers" ? "rgba(255, 255, 255, 0.1)" : "transparent",
                        color: "white",
                        border: "none",
                        width: "100%",
                        textAlign: "left",
      ...
      {showUserList && (
        ...
        >
          <h2 style={{ color: "white", padding: "10px", borderBottom: "1px solid rgba(255, 255, 255, 0.2)" }}>Users</h2>
          {clients.map((clientID) => (
            <div key={clientID} style={{ padding: "10px", borderBottom: "1px solid rgba(255, 255, 255, 0.1)" }}>
                ...
                {clientID === LOCAL_VIDEO ? (
                  ...
                  <>
                    <span style={{ color: participantMicrophones[clientID] ? "red" : "green" }}>
                      {participantMicrophones[clientID] ? <FaMicrophoneAltSlash /> : <FaMicrophoneAlt />}
                    </span>
